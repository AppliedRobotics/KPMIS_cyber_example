/*
  Библиотека для работы с DXL моторами на плате Коршун
  
  Определения регистров и констант для работы с Dynamixel-совместимыми
  контроллерами моторов через DXL шину.
  
  Автор: AI Assistant
  Дата: 2025
*/

#ifndef __ARDU_DRIVE_H__
#define __ARDU_DRIVE_H__

// Регистры DXL контроллера моторов
...
#define MAX_MOTOR_SPEED_TICKS     (700)    // Максимальная скорость в тиках
#define TICKS_TO_RAD_PER_SEC      (0.0157) // Коэффициент преобразования тиков в рад/сек
#define RAD_PER_SEC_TO_TICKS      (63.66)  // Коэффициент преобразования рад/сек в тики

#endif /* __ARDU_DRIVE_H__ */
